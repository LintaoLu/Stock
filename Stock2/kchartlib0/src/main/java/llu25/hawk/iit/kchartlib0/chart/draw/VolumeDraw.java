package llu25.hawk.iit.kchartlib0.chart.draw;
...
import llu25.hawk.iit.kchartlib0.R;
import llu25.hawk.iit.kchartlib0.chart.base.IChartDraw;
import llu25.hawk.iit.kchartlib0.chart.base.IValueFormatter;
import llu25.hawk.iit.kchartlib0.chart.entity.IVolume;
import llu25.hawk.iit.kchartlib0.chart.formatter.BigValueFormatter;
import llu25.hawk.iit.kchartlib0.utils.ViewUtil;
...
public class VolumeDraw implements IChartDraw<IVolume> {
    ...
    public VolumeDraw(llu25.hawk.iit.kchartlib0.chart.BaseKChartView view) {
    ...
    public void drawTranslated(
            ...
            @NonNull Canvas canvas, @NonNull llu25.hawk.iit.kchartlib0.chart.BaseKChartView view, int position) {
    ...
    private void drawHistogram(
            ...
            llu25.hawk.iit.kchartlib0.chart.BaseKChartView view, int position) {
    ...
    public void drawText(
            @NonNull Canvas canvas, @NonNull llu25.hawk.iit.kchartlib0.chart.BaseKChartView view, int position, float x, float y) {
