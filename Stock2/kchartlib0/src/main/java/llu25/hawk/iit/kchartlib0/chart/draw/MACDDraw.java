...
import llu25.hawk.iit.kchartlib0.chart.entity.IMACD;
import llu25.hawk.iit.kchartlib0.chart.formatter.ValueFormatter;
...
public class MACDDraw implements IChartDraw<IMACD> {
    ...
    public MACDDraw(llu25.hawk.iit.kchartlib0.chart.BaseKChartView view) {
    ...
    @Override
    public void drawText(@NonNull Canvas canvas, @NonNull llu25.hawk.iit.kchartlib0.chart.BaseKChartView view, int position, float x, float y) {
        String text = "";
     ...
     * @param macd
     */
    private void drawMACD(Canvas canvas, llu25.hawk.iit.kchartlib0.chart.BaseKChartView view, float x, float macd) {
