...
import llu25.hawk.iit.kchartlib0.chart.entity.ICandle;
...
public class MainDraw implements IChartDraw<ICandle> {
     ...
     * @param canvas
     */
    private void drawSelector(llu25.hawk.iit.kchartlib0.chart.BaseKChartView view, Canvas canvas) {
        ...
        strings.add("H:" + point.getHighPrice());
        strings.add("L:" + point.getLowPrice());
        strings.add("O:" + point.getOpenPrice());
        strings.add("C:" + point.getClosePrice());
